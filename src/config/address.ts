...
export const TranchesAddress: { [network: string]: string } = {
  ...
  [NETWORKS.MAINNET]: "7deC49529B9526784375d0fDa52a6B18704F6E4e"
...
export const MasterChefAddress: { [network: string]: string } = {
  ...
  [NETWORKS.MAINNET]: "641E650995C69529Da0Ac9997e867c90Bc6E7213"
};
...
export const WTFRewardsAddress: { [network: string]: string } = {
  ...
  [NETWORKS.MAINNET]: "0x10F95A2F4Eb95455b4736A98888E8Afa18a1896E"
};
export const VeWTFAddress: { [network: string]: string } = {
  ...
  [NETWORKS.MAINNET]: "0x89f47d54BBfF42fc7C9fE8Ff4E7b91079B3d87CA"
};
export const FeeRewardsAddress: { [network: string]: string } = {
  [NETWORKS.DEVNET]: "0x14c4ec080ba871008797f9e6b20068de22756ad1",
  [NETWORKS.TESTNET]: "",
  [NETWORKS.MAINNET]: "0xed4694a5a3053f1f33bb083cA95fECB0D8A7A1ad"
};
